...
一款基于 Jetpack Compose 构建的 Android 个人记账应用，采用 Material 3 设计语言，支持深浅色主题、账单管理、分类统计、分类管理、Excel 导入导出、人情账本等功能。
...
│   ├── Transaction.kt             # 账单实体
│   ├── TransactionDao.kt          # 账单数据访问（含按日期范围查询）
